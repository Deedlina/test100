...
public class MyArray {
    ...
    /**
     * 方法说明：判断是否为数字</br>
     * 输入参数String sPara，需要判断的字符串</br>
     * 返回类型：如果字符串全部为数字类型，返回true，否则返回false
     */
     ...
     * @return 
     */
    public boolean checkYear(int iPara){
        if(iPara%400==0&&iPara%100!=0){
            return true;
        }
        if(iPara%4==0){
            return true;
