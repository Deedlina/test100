...
public class CheckBoxDemo extends JPanel implements ItemListener {
     ...
     */
    private static final long serialVersionUID = 3147991153269736265L;
    ...
    /*
     * 有四个检查盒，分别对应下巴、眼镜、头发和牙齿 图片不是拼出来的，而是根据检查盒选择拼写图片文件名
     * 图片文件名的定义格式为"geek-XXXX.gif" 其中 XXXX 根据检查盒的不同选择，而不同。它的格式如下：
     * 
     * ---- //没有选择
     * 
     * c--- //一个选择 -g-- --h- ---t
     * 
     * cg-- //两个选择 c-h- c--t -gh- -g-t --ht
     * 
     * -ght //三个选择 c-ht cg-t cgh-
     * 
     * cght //所有都选
     */
    ...
    /**
     * 方法说明：监听检查盒事件，拼凑图片的文件名XXXX部分 <br>
     * 输入参数： <br>
     * 返回类型：
     */
    @Override
