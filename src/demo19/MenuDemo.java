...
public class MenuDemo implements ActionListener, ItemListener {
    ...
    public JMenuBar createMenuBar() {
        ...
        // 只有文字
        menuItem = new JMenuItem("(O)只有文本的菜单", KeyEvent.VK_O);
        // 设置快捷键
     ...
     * <br>
     * 方法说明：监听检查盒菜单选择项 <br>
     * 输入参数：ItemEvent e 检查盒触发的事件 <br>
     * 返回类型：
     */
    @Override
    public void itemStateChanged(ItemEvent e) {
        JMenuItem source = (JMenuItem) (e.getSource());
        String s = "菜单项监听" + newline + "    事件源: " + source.getText() + " (选择对象 " + getClassName(source) + ")" + newline
                + "    新的状态: " + ((e.getStateChange() == ItemEvent.SELECTED) ? "选择" : "不选择");
        output.append(s + newline);
    }
