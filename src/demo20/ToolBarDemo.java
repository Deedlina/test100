 ...
 * @Description: 工具栏演示:提供一个工具栏，包括“打开”、“保存”、“搜索”工具按钮
 * @author win10
 * @date 2017年6月22日 上午10:09:50
 */
...
public class ToolBarDemo extends JPanel implements ActionListener {
    ...
    protected void addButtons(JToolBar toolBar) {
        ...
        // 第一个按钮，“打开”
        button = makeNavigationButton("Open16", OPEN, "打开一个文件！", "打开");
        toolBar.add(button);

        // 第二个按钮，“保存”
        button = makeNavigationButton("Save16", SAVE, "保存当前文件！", "保存");
        toolBar.add(button);

        // 第三个按钮，“搜索”
        button = makeNavigationButton("Search16", SEARCH, "搜索文件中的字符！", "搜索");
        toolBar.add(button);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        displayResult("如果这里是真正的程序，你将进入： " + description);
    }
