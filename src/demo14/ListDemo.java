...
public class ListDemo extends JPanel implements ListSelectionListener {
     ...
     */
    private static final long serialVersionUID = -1503661163985149376L;
    private JList list;
    ...
    class HireListener implements ActionListener, DocumentListener {
        ...
        /**
         * <br>
         * 方法说明：检测是否在LIST中有重名元素 <br>
         * 输入参数：String name 检测的名字 <br>
        ...
        /**
         * <br>
         * 方法说明：实现DocumentListener接口，必需实现的方法 <br>
         * 输入参数： <br>
         * 返回类型：
         */
        @Override
        ...
        /**
         * <br>
         * 方法说明：实现DocumentListener接口，必需实现的方法，修改按钮的状态 <br>
         * 输入参数： <br>
         * 返回类型：
         */
    ...
    /**
     * <br>
     * 方法说明：实现ListSelectionListener接口，必需实现的方法 <br>
     * 输入参数： <br>
     * 返回类型：
     */
    @Override
