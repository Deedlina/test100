...
public class DialogDemo extends JPanel {
    ...
    /**
     * <br>
     * 方法说明：提供给createSimpleDialogBox和createFeatureDialogBox方法 <br>
     * 方法说明：创建带提示信息、一列单选框和“显示”按钮 <br>
     * 输入参数：String description 提示帮助信息 <br>
     * 输入参数：JRadioButton[] radioButtons 单选框组 <br>
     * 输入参数：JButton showButton “显示”按钮 <br>
     * 返回类型：JPanel 添加好的面板
     */
     ...
     * <br>
     * 方法说明：创建第三个选项卡的面板 <br>
     * 方法说明：这里都是实现showMessageDialog类，但是也可以指定图标 <br>
     * 输入参数： <br>
     * 返回类型：JPanel 构造好的面板
     */
